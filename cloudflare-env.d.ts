// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 113794664393a7caf7b1ed64ad0f0882)
// Runtime types generated with workerd@1.20250321.0 2024-09-26 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		template_kv: KVNamespace;
		NEXTJS_ENV: string;
		NEXT_CACHE_REVALIDATION_DURABLE_OBJECT: DurableObjectNamespace /* DurableObjectQueueHandler from NEXT_CACHE_REVALIDATION_DURABLE_OBJECT */;
